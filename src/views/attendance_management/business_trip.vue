    ...
    <template #form>
      <div :tabindex="0" @keyup.enter.stop="addAndUpdateAxios" class="form">
        <div class="dialog-cell-item">
          ...
          <el-input ref="businessTripEmpId" @change="empIsExist = false" @keyup.enter.stop.native="getEmployee"
    ...
    methods: {
      ...
      async addAndUpdateAxios() {
        const {
          ...
          restTime, id, description, $message, isUpdateOperation
        } = this;
        if(!empIsExist) {
          $message({
            message: "請先輸入員工!",
